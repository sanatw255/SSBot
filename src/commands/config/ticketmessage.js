...
module.exports = async (client, interaction, args) => {
  ...
  if (type == "open") {
    ...
    try {
      ...
      console.error("Error setting open ticket message:", err);
      client.errNormal(
        {
          error: "An error occurred while setting the ticket message.",
          type: "editreply",
        },
        interaction
      );
    ...
    try {
      ...
      console.error("Error setting close ticket message:", err);
      client.errNormal(
        {
          error: "An error occurred while setting the ticket message.",
          type: "editreply",
